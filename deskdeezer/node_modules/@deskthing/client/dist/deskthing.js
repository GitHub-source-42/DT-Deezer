...
import { EventMode, DEVICE_CLIENT, LOGGING_LEVELS, CLIENT_REQUESTS, } from "@deskthing/types";
export class DeskThingClass {
    ...
    constructor() {
        ...
        this.formatImageUrl = (image) => {
            ...
            return image.replace("localhost:8891", `${this.manifest.context.ip}:${this.manifest.context.port}`);
        };
        this.initialize();
