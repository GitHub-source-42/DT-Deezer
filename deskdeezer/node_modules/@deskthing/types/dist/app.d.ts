...
import { EventPayload, Log, ToServerData } from "./index.js";
...
export declare enum SEND_TYPES {
     ...
     *
     * @example
     * DeskThing.send({ type: SEND_TYPES.SONG, request: 'add', payload: { id: 'mySong', title: 'My Song', artist: 'Artist Name' }})
     */
    SONG = "song"
}
/**
 * Part of the {@link AppDataInterface} that holds the unknown data
 */
export type SavedData = Record<string, unknown>;
type WrappedAppProcessData = {
    version: string;
};
/**
 ...
 * @since 0.11.0
 */
export type AppProcessData = WrappedAppProcessData & ({
    type: "data";
    payload: ToServerData;
} | {
    type: "binary";
